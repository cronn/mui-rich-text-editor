...
type EditorToolbarInjectedProps = Omit<
  EditorToolbarProps,
  "editor" | "disableLink" | "disableImageUpload"
>;

export interface RichTextControlProps<
  TFormValues extends FieldValues,
> extends EditorToolbarInjectedProps {
  label: string;
  helperText?: string;
...
export const RichTextControl = forwardRef(RichTextControlInner) as <
  TFormValues extends FieldValues,
>(
  props: RichTextControlProps<TFormValues> & {
    useController: UseControllerHook<TFormValues>;
